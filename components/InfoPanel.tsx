...
export default function InfoPanel({ product, categoryName, onClose, onDelete, onUpdateNotes }: InfoPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      <div className="fade-in absolute inset-0 bg-ink-950/30" onClick={onClose} />
      <aside className="panel-in absolute right-0 top-0 flex h-full w-full max-w-[420px] flex-col border-l border-ink-200 bg-paper shadow-pop">
        {/* Header */}
